...
pub async fn start_app(
    ...
    *state.streaming_recorder.lock().unwrap() = None;
    ...
    let on_start = move |trigger_mode: config::TriggerMode, is_release_mode: bool| {
        ...
        let target_hwnd = crate::platform::input::get_foreground_window();
...
#[tauri::command]
pub async fn stop_app(app_handle: AppHandle) -> Result<String, String> {
    tracing::info!("停止应用...");
...
#[tauri::command]
pub async fn cancel_transcription(app_handle: AppHandle) -> Result<String, String> {
    tracing::info!("取消转录...");
...
/// 用户点击悬浮窗完成按钮时调用
#[tauri::command]
pub async fn finish_locked_recording(app_handle: AppHandle) -> Result<String, String> {
...
/// 用户点击悬浮窗取消按钮时调用
#[tauri::command]
pub async fn cancel_locked_recording(app_handle: AppHandle) -> Result<String, String> {
