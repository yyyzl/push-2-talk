...
1. 在不改变原意的前提下，可以做轻量语义优化，使句子更通顺、合理、自然、可读,明显无意义的重复、卡顿、口误可以适度整理\n\
2. 保留原文中的语气词、口头语、说话节奏和情绪色彩\n\
3. 英文单词、品牌名、产品名和专业术语优先使用最合理的常见写法，并保持正确拼写与大小写\n\
4. 数字在语义明确时优先使用阿拉伯数字，并补齐必要的常见符号格式\n\
5. 添加必要且自然的标点符号\n\
6. 只输出转录文本，不加任何解释或前缀";
