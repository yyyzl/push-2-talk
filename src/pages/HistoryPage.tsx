...
import { Clock, Copy, History, Trash2, Wand2, Mic } from "lucide-react";
                ...
                {record.success ? (
                  record.polishedText ? (
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="flex flex-col min-h-0 bg-[rgba(217,119,87,0.08)] rounded-xl p-3 border border-[var(--stone)]">
                        <div className="flex items-center justify-between mb-2">
                          <div className="text-[11px] font-bold text-[var(--crail)] flex items-center gap-1">
                    ...
                    <div className="flex flex-col bg-stone-50/60 rounded-xl p-3 border border-stone-200">
                      <div className="flex items-center justify-between mb-2">
                        <div className="text-[11px] font-bold text-stone-500">转写结果</div>
                        <button
                          onClick={(e) => onCopyText(record.originalText, e)}
