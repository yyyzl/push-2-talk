...
export interface SmartCommandConfig {
  enabled: boolean;
  endpoint: string;
  model: string;
  api_key: string;
...
// 应用状态
export type AppStatus = "idle" | "running" | "recording" | "transcribing";
...
// 服务配置弹窗 Tab
export type ServiceModalTab = 'asr' | 'llm' | 'assistant' | 'dictionary';
