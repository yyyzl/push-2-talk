import type { HotkeyKey, LlmPreset, LlmConfig, SmartCommandConfig, AssistantConfig, AsrProvider, AsrProviderMeta } from '../types';
...
// Smart Command 默认配置（保留用于向后兼容）
export const DEFAULT_SMART_COMMAND_CONFIG: SmartCommandConfig = {
  enabled: false,
  endpoint: "https://open.bigmodel.cn/api/paas/v4/chat/completions",
  model: "glm-4-flash-250414",
  api_key: "",
